...
public class Pager {
	...
	private int totalArticle; //전체 게시글 갯수
	private int pageSize;     //페이지당 출력될 게시글 갯수
	private int blockSize;    //블럭당 출력될 페이지 갯수
	
	private int totalPage;    //전체 페이지 갯수
	private int startRow;     //현재 페이지에 출력될 게시글 시작 번호
	private int endRow;       //현재 페이지에 출력될 게시글 종료 번호
